            ...
            <div class="row row-sm-height">
              <div class="col-sm-12 col-sm-height col-middle">
                ...
                <form id="form-data_peminjaman" class="p-t-15" role="form" action="reservasi2">
                  <h4>Data Pembayaran Peminjaman Sepeda</h4>
                    ...
                    <div class="col-sm-12">
                      <div class="form-group form-group-default">
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="">
                              <label>Sepeda Anak - Anak</label>
                              <select class=" full-width" multiple>
                                <option value="Jim">S001</option>
                                <option value="John">S002</option>
                                <option value="Lucy">S003</option>
                              </select>
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form-group form-group-default">
                              <label>Sepeda Standar</label>
