      ...
      <div class="sidebar-menu">
        ...
        <ul class="menu-items">
          <li class="m-t-30 open">
            ...
            <span class="icon-thumbnail bg-success"><i class="fa fa-money"></i></span>
          </li>
          <li class="m-t-30 open">
          ...
          <li class="">
            <a href="Pembatalan" class="detailed">
              <span class="title">Pembatalan</span>
            </a>
            <span class="icon-thumbnail "><i class="fa fa-times-circle"></i></span>
          </li>
          <li class="">
            <a href="peminjaman"><span class="title">Pengambilan</span></a>
            <span class="icon-thumbnail "><i class="fa fa-arrow-circle-o-left"></i></span>
          </li>
          <li class="">
            <a href="Pengembalian"><span class="title">Pengembalian</span></a>
