                ...
                <table class="table table-striped" id="tableWithExportOptions">
                  ...
                  <tbody>
                    <tr class="odd gradeX">
                      ...
                      <td >PG01110</td>
                      <td>1</td>
                      <td><button class="btn btn-info btn-cons m-b-10" type="button"><i class="fa fa-paste"></i> <span class="bold">Edit</span> <button class="btn btn-danger btn-cons m-b-10" type="button"><i class="fa fa-warning"></i>
                      <span class="bold">Delete</span></td>
